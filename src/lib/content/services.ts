export const servicesContent = {
  en: {
    ...
    items: [
      ...
      { name: 'Game Monetization Strategy', description: 'Designing effective and player-friendly monetization models to maximize revenue without compromising experience.' },
      { name: 'Live Ops & Community Management', description: 'Managing post-launch updates, events, and fostering an engaged player community.' },
  ...
  ar: {
    ...
    items: [
      ...
      { name: 'استراتيجية تحقيق الدخل من الألعاب', description: 'تصميم نماذج تحقيق دخل فعالة وصديقة للاعبين لزيادة الإيرادات دون المساس بالتجربة.' },
      { name: 'العمليات الحية وإدارة المجتمع', description: 'إدارة تحديثات ما بعد الإطلاق والفعاليات وتعزيز مجتمع لاعبين متفاعل.' },
