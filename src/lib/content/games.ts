...
export const gamesContent = [
  {
    ...
    storeLinks: [
        { store: 'steam', url: '#', label: { en: 'Wishlist on Steam', ar: 'أضفها لقائمة الرغبات على ستيم' } },
        { store: 'itch', url: '#', label: { en: 'Buy on Itch.io', ar: 'اشترِ على Itch.io' } },
    ],
    heroImage: 'https://placehold.co/1920x1080.png',
    heroImageHint: 'gameplay explosion',
  ...
  },
  {
    ...
    storeLinks: [
        { store: 'appstore', url: '#', label: { en: 'Download on the App Store', ar: 'حمّل من متجر التطبيقات' } },
        { store: 'googleplay', url: '#', label: { en: 'Get it on Google Play', ar: 'احصل عليه من جوجل بلاي' } },
    ],
    heroImage: 'https://placehold.co/1920x1080.png',
