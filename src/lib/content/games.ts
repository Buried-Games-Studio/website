...
export const gamesContent = [
  {
    ...
    logoUrl: 'https://assets.buriedgames.com/site/images/games/arrab/logo.53788a85.png',
    description: {
    ...
    storeLinks: [],
    heroImage: 'https://assets.buriedgames.com/site/images/games/arrab/hero-bg.d55d0eea.png',
    heroImageHint: 'dark mafia noir lounge',
    heroVideo: null,
    imageUrl: 'https://assets.buriedgames.com/site/images/games/arrab/hero-right.c3f040bc.png',
    imageHint: 'mafia godfather silhouette',
    videoUrl: null,
    gallery: [
      { url: 'https://assets.buriedgames.com/site/images/games/arrab/hero-bg.d55d0eea.png', hint: 'Noir lounge background' },
      { url: 'https://assets.buriedgames.com/site/images/games/arrab/hero-right.c3f040bc.png', hint: 'Godfather silhouette' },
    ],
    roles: [
      { id: 'godfather', team: 'mafia', name: { en: 'Godfather', ar: 'العرّاب' }, action: { en: 'Kill', ar: 'قتل' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/godfather.871a696a.png' },
      { id: 'mafia-member', team: 'mafia', name: { en: 'Mafia Member', ar: 'عضو المافيا' }, action: { en: 'Kill', ar: 'قتل' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/mafia-member.f0dada97.png' },
      { id: 'barman', team: 'mafia', name: { en: 'Barman', ar: 'البارمان' }, action: { en: 'Block', ar: 'حظر' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/barman.c4c6cbd4.png' },
      { id: 'doctor', team: 'town', name: { en: 'Doctor', ar: 'الدكتور' }, action: { en: 'Save', ar: 'إنقاذ' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/doctor.cd9218c7.png' },
      { id: 'detective', team: 'town', name: { en: 'Detective', ar: 'المحقق' }, action: { en: 'Investigate', ar: 'تحقيق' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/detective.8f09336d.png' },
      { id: 'bodyguard', team: 'town', name: { en: 'Bodyguard', ar: 'الحارس الشخصي' }, action: { en: 'Protect', ar: 'حماية' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/bodyguard.eab74ea8.png' },
      { id: 'sniper', team: 'town', name: { en: 'Sniper', ar: 'القنّاص' }, action: { en: 'Snipe', ar: 'قنص' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/sniper.b59a3939.png' },
      { id: 'villager', team: 'town', name: { en: 'Villager', ar: 'المواطن' }, action: { en: 'Vote', ar: 'تصويت' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/villager.26d8ce08.png' },
      { id: 'jester', team: 'neutral', name: { en: 'Jester', ar: 'المهرج' }, action: { en: 'Deceive', ar: 'خداع' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/jester.04cd7459.png' },
      { id: 'serial-killer', team: 'neutral', name: { en: 'Serial Killer', ar: 'القاتل المتسلسل' }, action: { en: 'Kill', ar: 'قتل' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/serial-killer.4a3b1f6a.png' },
      { id: 'kamikaze', team: 'town', name: { en: 'Kamikaze', ar: 'الانتحاري' }, action: { en: 'Sacrifice', ar: 'تضحية' }, image: 'https://assets.buriedgames.com/site/images/games/arrab/roles/kamikaze.c75cbf10.png' },
    ],
  },
  {
    id: 'nabsh',
    ...
    heroImage: 'https://assets.buriedgames.com/site/images/games/nabsh/hero.ed6c1c2e.png',
    heroImageHint: 'trivia quiz brain',
    heroVideo: 'https://nabsh.fun/videos/hero-animation-video.mp4',
    imageUrl: 'https://assets.buriedgames.com/site/images/games/nabsh/hero.ed6c1c2e.png',
    imageHint: 'trivia game',
    videoUrl: 'https://www.youtube.com/embed/F0WBKweQ-NM',
    categories: [
      { name: { en: 'Celebrities', ar: 'المشاهير' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/celebrities.17ee7e48.jpg' },
      { name: { en: 'Movies', ar: 'افلام' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/movies.42661aad.webp' },
      { name: { en: 'Sports', ar: 'رياضة' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/sports.be3c4b76.webp' },
      { name: { en: 'Cars', ar: 'سيارات' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/cars.2118f834.webp' },
      { name: { en: 'Animals', ar: 'حيوانات' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/animals.46b67d86.webp' },
      { name: { en: 'Cartoon', ar: 'رسوم متحركه' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/cartoon.3a07b974.webp' },
      { name: { en: 'Video Games', ar: 'الالعاب' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/videogames.4b1cddf3.jpg' },
      { name: { en: 'Songs', ar: 'اغاني' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/songs.330b85a2.webp' },
      { name: { en: 'Kuwait', ar: 'الكويت' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/kuwait.f51c8edb.webp' },
      { name: { en: 'Mathematics', ar: 'رياضيات' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/math.a9f6dd93.webp' },
      { name: { en: 'Plays', ar: 'مسرحيات' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/plays.7d594aaa.webp' },
      { name: { en: 'Perfumes', ar: 'عطورات عالميه' }, image: 'https://assets.buriedgames.com/site/images/games/nabsh/categories/perfumes.e915e3bf.jpg' },
    ],
    gallery: [],
  },
  {
    ...
    logoUrl: 'https://assets.buriedgames.com/site/images/powerofbombsIconTransparent.5d243419.png',
    description: {
    ...
    heroVideo: null,
    imageUrl: 'https://assets.buriedgames.com/site/images/buriedgames_logo.6d162dd3.png',
  ...
  },
  {
    ...
    heroVideo: 'https://assets.buriedgames.com/site/videos/koutq8-hero.45690fd1.mp4',
    imageUrl: 'https://assets.buriedgames.com/site/images/buriedgames_logo.6d162dd3.png',
    imageHint: 'card game',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    gallery: [
  ...
  },
  {
    ...
    status: 'released',
    engine: 'Next.js',
    logoUrl: 'https://assets.buriedgames.com/site/images/luna-fantasy_logo.e4fed1cf.png',
    description: {
    ...
    heroImage: 'https://assets.buriedgames.com/site/images/games/luna-fantasy/hero.28a211bb.png',
    heroImageHint: 'fantasy card game universe',
    heroVideo: null,
    imageUrl: 'https://assets.buriedgames.com/site/images/games/luna-fantasy/hero.28a211bb.png',
    imageHint: 'luna fantasy characters',
    videoUrl: null,
    gallery: [
      { url: 'https://assets.buriedgames.com/site/images/games/luna-fantasy/our-characters.fea55dc0.png', hint: 'Luna Fantasy characters gallery' },
      { url: 'https://assets.buriedgames.com/site/images/games/luna-fantasy/card-legendary.668218f1.png', hint: 'Legendary rarity card' },
      { url: 'https://assets.buriedgames.com/site/images/games/luna-fantasy/card-epic.75422bd2.png', hint: 'Epic rarity card' },
      { url: 'https://assets.buriedgames.com/site/images/games/luna-fantasy/champion.000ae260.png', hint: 'Champion story art' },
      { url: 'https://assets.buriedgames.com/site/images/games/luna-fantasy/char-sentinel.d73ac6fa.png', hint: 'Luna Sentinel character' },
      { url: 'https://assets.buriedgames.com/site/images/games/luna-fantasy/char-knight.4892a9bb.png', hint: 'Luna Knight character' },
    ],
  },
  {
    ...
    storeLinks: [],
    heroImage: 'https://assets.buriedgames.com/site/images/games/gbtl/poster.9b4e0eaa.png',
    heroImageHint: 'pixel art moth forest',
    heroVideo: 'https://assets.buriedgames.com/site/videos/gbtl-hero.e4acc123.mp4',
    imageUrl: 'https://assets.buriedgames.com/site/images/games/gbtl/poster.9b4e0eaa.png',
    imageHint: 'pixel art platformer',
    videoUrl: null,
    gallery: [
      { url: 'https://assets.buriedgames.com/site/images/games/gbtl/poster.9b4e0eaa.png', hint: 'Game poster' },
      { url: 'https://assets.buriedgames.com/site/images/games/gbtl/start-screen.49fb2742.png', hint: 'Start screen' },
      { url: 'https://assets.buriedgames.com/site/images/games/gbtl/tileset.95706978.png', hint: 'Level tileset' },
    ],
    comicSlides: [
      'https://assets.buriedgames.com/site/images/games/gbtl/comic-1.5892dd16.png',
      'https://assets.buriedgames.com/site/images/games/gbtl/comic-2.89b2b41d.png',
      'https://assets.buriedgames.com/site/images/games/gbtl/comic-3.da3bc8fc.png',
      'https://assets.buriedgames.com/site/images/games/gbtl/comic-4.9800faa8.png',
      'https://assets.buriedgames.com/site/images/games/gbtl/comic-5.11577aa3.png',
    ],
    characters: [
      { name: { en: 'Moth (Hero)', ar: 'الفراشة (البطل)' }, sprite: 'https://assets.buriedgames.com/site/images/games/gbtl/moth-jump.4f48cd86.gif' },
      { name: { en: 'Father', ar: 'الأب' }, sprite: 'https://assets.buriedgames.com/site/images/games/gbtl/father.99b467b2.gif' },
      { name: { en: 'Mother', ar: 'الأم' }, sprite: 'https://assets.buriedgames.com/site/images/games/gbtl/mother.267622b5.gif' },
      { name: { en: 'Spider Boss', ar: 'زعيم العنكبوت' }, sprite: 'https://assets.buriedgames.com/site/images/games/gbtl/spider.58053b3e.gif' },
    ],
    designAssets: [
      { label: { en: 'Grappling Hook', ar: 'خطاف التسلق' }, image: 'https://assets.buriedgames.com/site/images/games/gbtl/grappling-hook.59c998cd.gif' },
      { label: { en: 'Checkpoint', ar: 'نقطة حفظ' }, image: 'https://assets.buriedgames.com/site/images/games/gbtl/checkpoint.8e650b28.gif' },
      { label: { en: 'Jump Hint', ar: 'تلميح القفز' }, image: 'https://assets.buriedgames.com/site/images/games/gbtl/hint-jump.f622a243.gif' },
      { label: { en: 'Movement', ar: 'الحركة' }, image: 'https://assets.buriedgames.com/site/images/games/gbtl/hint-move.9e2a3014.gif' },
    ],
    trailerUrl: 'https://assets.buriedgames.com/site/videos/gbtl-trailer.7ad48cfd.mp4',
  },
];
